...
public class IabHelper {
    ...
    public interface OnIabSetupFinishedListener {
         ...
         */
        void onIabSetupFinished(com.sonman.inapp.IabResult result);
    }
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                try {
                    ...
                    if (response != BILLING_RESPONSE_RESULT_OK) {
                        if (listener != null) listener.onIabSetupFinished(new com.sonman.inapp.IabResult(response,
                    ...
                    if (listener != null) {
                        listener.onIabSetupFinished(new com.sonman.inapp.IabResult(IABHELPER_REMOTE_EXCEPTION,
                ...
                if (listener != null) {
                    listener.onIabSetupFinished(new com.sonman.inapp.IabResult(BILLING_RESPONSE_RESULT_OK, "Setup successful."));
                }
            }
        };
        ...
        if (intentServices != null && !intentServices.isEmpty()) {
            ...
            if (listener != null) {
                listener.onIabSetupFinished(
                        new com.sonman.inapp.IabResult(BILLING_RESPONSE_RESULT_BILLING_UNAVAILABLE,
    ...
    public interface OnIabPurchaseFinishedListener {
         ...
         */
        void onIabPurchaseFinished(com.sonman.inapp.IabResult result, Purchase info);
    }
    ...
    public void launchPurchaseFlow(Activity act, String sku, String itemType, List<String> oldSkus,
        ...
        com.sonman.inapp.IabResult result;

        if (itemType.equals(ITEM_TYPE_SUBS) && !mSubscriptionsSupported) {
            com.sonman.inapp.IabResult r = new IabResult(IABHELPER_SUBSCRIPTIONS_NOT_AVAILABLE,
        ...
        try {
            ...
            if (oldSkus == null || oldSkus.isEmpty()) {
                ...
                if (!mSubscriptionUpdateSupported) {
                    com.sonman.inapp.IabResult r = new IabResult(IABHELPER_SUBSCRIPTION_UPDATE_NOT_AVAILABLE,
            ...
            if (response != BILLING_RESPONSE_RESULT_OK) {
                ...
                flagEndAsync();
                result = new com.sonman.inapp.IabResult(response, "Unable to buy item");
            ...
            result = new com.sonman.inapp.IabResult(IABHELPER_SEND_INTENT_FAILED, "Failed to send intent.");
            if (listener != null) listener.onIabPurchaseFinished(result, null);
        }
        catch (RemoteException e) {
            ...
            result = new com.sonman.inapp.IabResult(IABHELPER_REMOTE_EXCEPTION, "Remote exception while starting purchase flow");
            if (listener != null) listener.onIabPurchaseFinished(result, null);
        }
    }
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data == null) {
            ...
            result = new com.sonman.inapp.IabResult(IABHELPER_BAD_RESPONSE, "Null data in IAB result");
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
            ...
            if (purchaseData == null || dataSignature == null) {
                ...
                result = new com.sonman.inapp.IabResult(IABHELPER_UNKNOWN_ERROR, "IAB returned null purchaseData or dataSignature");
                if (mPurchaseListener != null) mPurchaseListener.onIabPurchaseFinished(result, null);
                return true;
            }

            com.sonman.inapp.Purchase purchase = null;
            try {
                purchase = new com.sonman.inapp.Purchase(mPurchasingItemType, purchaseData, dataSignature);
                String sku = purchase.getSku();

                // Verify signature
                if (!com.sonman.inapp.Security.verifyPurchase(mSignatureBase64, purchaseData, dataSignature)) {
                    logError("Purchase signature verification FAILED for sku " + sku);
                    result = new com.sonman.inapp.IabResult(IABHELPER_VERIFICATION_FAILED, "Signature verification failed for sku " + sku);
                ...
                e.printStackTrace();
                result = new com.sonman.inapp.IabResult(IABHELPER_BAD_RESPONSE, "Failed to parse purchase data.");
                if (mPurchaseListener != null) mPurchaseListener.onIabPurchaseFinished(result, null);
                return true;
            }

            if (mPurchaseListener != null) {
                mPurchaseListener.onIabPurchaseFinished(new com.sonman.inapp.IabResult(BILLING_RESPONSE_RESULT_OK, "Success"), purchase);
            }
        }
            ...
            if (mPurchaseListener != null) {
                result = new com.sonman.inapp.IabResult(responseCode, "Problem purchashing item.");
                mPurchaseListener.onIabPurchaseFinished(result, null);
            }
        }
        else if (resultCode == Activity.RESULT_CANCELED) {
            logDebug("Purchase canceled - Response: " + getResponseDesc(responseCode));
            result = new com.sonman.inapp.IabResult(IABHELPER_USER_CANCELLED, "User canceled.");
            if (mPurchaseListener != null) mPurchaseListener.onIabPurchaseFinished(result, null);
        }
        else {
            logError("Purchase failed. Result code: " + Integer.toString(resultCode)
                    + ". Response: " + getResponseDesc(responseCode));
            result = new com.sonman.inapp.IabResult(IABHELPER_UNKNOWN_PURCHASE_RESPONSE, "Unknown purchase response.");
            if (mPurchaseListener != null) mPurchaseListener.onIabPurchaseFinished(result, null);
        }
        return true;
    }

    public com.sonman.inapp.Inventory queryInventory() throws IabException {
     ...
     */
    public com.sonman.inapp.Inventory queryInventory(boolean querySkuDetails, List<String> moreItemSkus,
                                                                                List<String> moreSubsSkus) throws IabException {
        checkNotDisposed();
        checkSetupDone("queryInventory");
        try {
            com.sonman.inapp.Inventory inv = new Inventory();
    ...
    public interface QueryInventoryFinishedListener {
         ...
         */
        void onQueryInventoryFinished(com.sonman.inapp.IabResult result, Inventory inv);
    }
    ...
    public void queryInventoryAsync(final boolean querySkuDetails, final List<String> moreItemSkus,
        ...
        (new Thread(new Runnable() {
            public void run() {
                com.sonman.inapp.IabResult result = new IabResult(BILLING_RESPONSE_RESULT_OK, "Inventory refresh successful.");
                com.sonman.inapp.Inventory inv = null;
                try {
                ...
                final com.sonman.inapp.IabResult result_f = result;
                final com.sonman.inapp.Inventory inv_f = inv;
     ...
     */
    void consume(com.sonman.inapp.Purchase itemInfo) throws IabException {
        checkNotDisposed();
    ...
    public interface OnConsumeFinishedListener {
         ...
         */
        void onConsumeFinished(com.sonman.inapp.Purchase purchase, IabResult result);
    }
    ...
    public interface OnConsumeMultiFinishedListener {
         ...
         *     sku.
         */
        void onConsumeMultiFinished(List<com.sonman.inapp.Purchase> purchases, List<IabResult> results);
    }
     ...
     */
    public void consumeAsync(com.sonman.inapp.Purchase purchase, OnConsumeFinishedListener listener)
        throws IabAsyncInProgressException {
        checkNotDisposed();
        checkSetupDone("consume");
        List<com.sonman.inapp.Purchase> purchases = new ArrayList<Purchase>();
     ...
     * @param listener The listener to notify when the consumption operation finishes.
     */
    public void consumeAsync(List<com.sonman.inapp.Purchase> purchases, OnConsumeMultiFinishedListener listener)
        throws IabAsyncInProgressException {
        checkNotDisposed();
        checkSetupDone("consume");
    ...
    int queryPurchases(com.sonman.inapp.Inventory inv, String itemType) throws JSONException, RemoteException {
        // Query purchases
        ...
        do {
            ...
            for (int i = 0; i < purchaseDataList.size(); ++i) {
                ...
                if (com.sonman.inapp.Security.verifyPurchase(mSignatureBase64, purchaseData, signature)) {
                    logDebug("Sku is owned: " + sku);
                    com.sonman.inapp.Purchase purchase = new Purchase(itemType, purchaseData, signature);
    ...
    int querySkuDetails(String itemType, com.sonman.inapp.Inventory inv, List<String> moreSkus)
        ...
        for (ArrayList<String> skuPartList : packs) {
            ...
            for (String thisResponse : responseList) {
                com.sonman.inapp.SkuDetails d = new SkuDetails(itemType, thisResponse);
    ...
    void consumeAsyncInternal(final List<com.sonman.inapp.Purchase> purchases,
        ...
        (new Thread(new Runnable() {
            public void run() {
                final List<com.sonman.inapp.IabResult> results = new ArrayList<IabResult>();
                for (com.sonman.inapp.Purchase purchase : purchases) {
                    try {
                        consume(purchase);
                        results.add(new com.sonman.inapp.IabResult(BILLING_RESPONSE_RESULT_OK, "Successful consume of sku " + purchase.getSku()));
                    }
                    catch (IabException ex) {
