...
public class Cocos2dxDownloader {
    ...
    public static Cocos2dxDownloader createDownloader(int id, int timeoutInSeconds, String tempFileNameSufix, int countOfMaxProcessingTasks) {
        ...
        /**
         * cung la download tu https, download github thi duoc, nhung download tu gooogle thi bi ban loi
         * @see http://stackoverflow.com/questions/8839541/hostname-in-certificate-didnt-match
         * can phai khai vao SSL de download tu google
         * */
        try {
            cz.msebera.android.httpclient.conn.ssl.SSLSocketFactory sf = new cz.msebera.android.httpclient.conn.ssl.SSLSocketFactory(
                    SSLContext.getDefault(),
                    cz.msebera.android.httpclient.conn.ssl.SSLSocketFactory.ALLOW_ALL_HOSTNAME_VERIFIER
            );
            downloader._httpClient.setSSLSocketFactory(sf);
        } catch (Exception e) {
            e.printStackTrace();
        }
